...
- [x] Restaurar o botão explícito de continuidade na etapa 2 de anexos.
- [x] Validar a passagem de anexos para revisão com e sem arquivos enviados.
- [x] Cobrir o avanço efetivo da etapa 2 para revisão sem arquivo em teste de componente.
...
- [x] Validar na interface publicada a mensagem amigável da IA indisponível e a continuidade do preenchimento manual.
- [x] Registrar evidência verificável da operação publicada após a correção 412.
- [x] Exibir de forma persistente no painel do Assistente IA a orientação de indisponibilidade sem bloquear a revisão.
- [x] Validar no ambiente publicado a resposta persistente do painel após falha do Assistente IA.
